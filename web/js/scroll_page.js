...
$.extend(ScrollFlow.prototype,
    {
        ...
        update: function (forcedDuration) {
            var $this = this, winHeight, scrollTop, objOffset, objOffsetTop, effectDuration, effectiveFromPercentage, scrollDistancePercentage, effectiveFrom, effectiveTo, parallaxScale, parallaxOpacity, parallaxOffset, factor, options;
            ...
            $(".scrollflow").each(function (key, obj) {
                ...
                // Configuración de solicitud de objetos
